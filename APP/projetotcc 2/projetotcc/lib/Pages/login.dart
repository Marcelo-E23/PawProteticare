...
class _LoginState extends State<Login> {
              ...
              Center(
                child: Text(
                  ...
                  style: GoogleFonts.poppins(
                    ...
                    color: isDark ? const Color(0xFF4C8DFF) : const Color(0xFF1976D2),
                  ),
                ),
              ),
                      ...
                      onPressed: !_isFormValid || _isLoading
                          ...
                          : () async {
                              if (_formKey.currentState!.validate()) {
                                ...
                                final sucesso = await loginProvider.login(usuario, senha);
  ...
  Widget _buildTextFormField(
    ...
    final isValid = label == "Usuário" ? value.contains('@') : value.length >= 6;
    ...
    return TextFormField(
      ...
      decoration: InputDecoration(
        labelText: label == "Usuário" ? "Digite seu e-mail" : "Senha (mínimo 6 caracteres)",
        ...
        prefixIcon: icon != null
            ? Icon(icon, size: 18, color: isDark ? const Color(0xFF90CAF9) : const Color(0xFF1976D2))
            : null,
        suffixIcon: isPassword
            ? IconButton(
                icon: Icon(
                  ...
                  size: 18,
                  color: isDark ? const Color(0xFF90CAF9) : const Color(0xFF2196F3),
                ),
                onPressed: () {
                  setState(() {
      ...
      validator: (value) {
        if (value == null || value.trim().isEmpty) return '⚠️ Preencha o campo ${label.toLowerCase()}';
        if (label == "Usuário" && !value.contains('@')) return '⚠️ Digite um e-mail válido';
        if (label == "Senha" && value.length < 6) return '⚠️ Senha deve ter pelo menos 6 caracteres';
        return null;
      },
    );
  }
