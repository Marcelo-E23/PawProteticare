...
class _CadastroState extends State<Cadastro> {
  ...
  void atualizarConfirmarSenhaVisual(String valor) {
    setState(() {
      confirmarSenhaValida = valor.trim().isEmpty ? null : valor == _senhaController.text;
    });
  }
  ...
  bool emailValido(String value) => value.contains('@');
  ...
  Future<void> _cadastrar() async {
    ...
    if (sucesso) {
      showDialog(
        ...
        builder: (_) => AlertDialog(
          ...
          content: Column(
            ...
            children: [
              const Icon(Icons.check_circle_outline, color: Color(0xFF00C0BD), size: 48),
          ...
          actions: [
            TextButton(
              ...
              child: const Text('Ir para o login', style: TextStyle(color: Color(0xFF00C0BD))),
            ),
          ],
        ),
      );
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Erro ao cadastrar. Tente novamente.', style: TextStyle(color: Colors.white)),
          ...
          child: Column(
            ...
            children: [
              ...
              const Text(
                'Cadastre-se',
                textAlign: TextAlign.center,
                style: TextStyle(fontSize: 28, fontWeight: FontWeight.bold, color: Color(0xFF00C0BD)),
              ),
              const SizedBox(height: 8),
              const Text(
              ...
              GestureDetector(
                ...
                child: const Text(
                  ...
                  style: TextStyle(fontSize: 14, color: Color(0xFF00C0BD), decoration: TextDecoration.underline),
                ),
              ),
              const SizedBox(height: 24),
              ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                  backgroundColor: camposValidos() ? const Color(0xFF00C0BD) : const Color(0xFF83A3A5),
                  foregroundColor: Colors.white,
                  padding: const EdgeInsets.symmetric(vertical: 14),
                  minimumSize: const Size(double.infinity, 50),
                  shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12)),
                  elevation: camposValidos() ? 4 : 0,
                  shadowColor: camposValidos() ? Colors.black.withOpacity(0.2) : Colors.transparent,
                  textStyle: const TextStyle(fontSize: 16, fontWeight: FontWeight.bold),
                ),
                child: const Text('Cadastrar', semanticsLabel: 'Botão para cadastrar'),
              ),
            ],
          ),
        ),
      ...
      children: [
        TextFormField(
          ...
          decoration: InputDecoration(
            ...
            suffixIcon: suffixIcon ?? (valido != null ? Icon(valido ? Icons.check_circle : Icons.cancel, color: valido ? Colors.green : const Color(0xFFE53935), size: 20) : null),
            filled: true,
            ...
            enabledBorder: OutlineInputBorder(
              ...
              borderSide: BorderSide(color: mostrarErro ? const Color(0xFFE53935) : const Color(0xFFA2BEBD), width: 1.5),
            ),
            focusedBorder: OutlineInputBorder(
              borderRadius: BorderRadius.circular(12),
              borderSide: BorderSide(color: mostrarErro ? const Color(0xFFE53935) : const Color(0xFF00C0BD), width: 2),
            ),
          ),
        ),
        if (valido != null || campoVazio)
          Padding(
            ...
            child: Text(
              campoVazio ? 'Campo obrigatório' : (valido == true ? mensagemFeedbackValido : mensagemFeedbackInvalido),
              style: TextStyle(color: campoVazio ? const Color(0xFF9ADCDD) : (valido == true ? Colors.green : const Color(0xFFE53935)), fontSize: 12),
            ),
          ),
      ],
    );
