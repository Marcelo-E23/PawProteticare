...
public class AuthenticationService {
	...
	public AuthenticationResponse register(RegisterRequest request) {
		...
		try {
			...
			Class<?> clazz = Class.forName("br.com.pawproteticare.api.model.entity." + nomeClasse); // Obtém a classe
			UsuarioEntity usuario = (UsuarioEntity) clazz.newInstance(); // Instancia o objeto
