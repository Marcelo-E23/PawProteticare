...
public class AnimachadoServiceImpl implements IAnimachadoService {
    ...
    public AnimachadoEntity salvar(AnimachadoEntity animal) {
      ...
      //  }
        animal.setStatus(StatusAdocao.AGUARDANDO_AVALIACAO);
    ...
    @Override
    public Optional<AnimachadoEntity> buscarPorStatus(StatusAdocao Status) {
    ...
    @Override
    public Optional<AnimachadoEntity> findById(Long id) {
    ...
    @Override
    public Optional<AnimachadoEntity> findByStatus(StatusAdocao statusAdocao) {
        return Optional.empty();
    }
